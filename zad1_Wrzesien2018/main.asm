...
_main PROC
	...
	mov edi, offset bufor + 2048 ; do edi przypisuje adres poczatkowy wynikow
ptl:
	mov eax, [esi]
...
sprawdz_kolejna_1:
	...
	jmp ptl_przesuniec
wynik_dekodowania_0:
	btr ebx, 0	; zapisanie do CF 0 a na najmlodszym bicie 0
	clc
	shl ebx, 1
	jmp ptl_przesuniec
...
zapisz_wynik_do_pamieci:
	mov [edi], ebx	; zapisanie do pamieci wyniku rejestr ebx ktory wystepuje jako tymczasowa zmienna do dekodowania sygnalu
	mov eax, 0	; aby nie powodowalo zaklaman w eax i ebx w kolejnych obiegach petli
	mov ebx, 0
